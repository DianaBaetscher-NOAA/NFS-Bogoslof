...
taxonomy <- read_csv("csv_outputs/fecal_mifish_collapsed_taxonomy.csv")
...
combined_df %>%
  ...
  unique()
```
167 ASVs without taxonomy (removed).
...
## CHECK IN WITH KIM ABOUT SALMON/GADIDS SEQUENCES ##
...
## Get Kim's sequences for gadids/salmon
